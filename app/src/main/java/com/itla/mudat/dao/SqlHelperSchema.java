...
public class SqlHelperSchema {
    ...
    public static final String ANUNCIO_TABLE = "CREATE TABLE anuncio (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, categoria INTEGER, usuario INTEGER, date TEXT, condicion TEXT, precio REAL, titulo TEXT, ubicacion TEXT, descripcion TEXT, FOREIGN KEY(usuario) REFERENCES usuario(id), FOREIGN KEY(categoria) REFERENCES categoria(id) )";
